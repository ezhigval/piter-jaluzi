        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 group">
              ...
              <h3 className="text-xl font-light mb-3 text-gray-900">От 1 окна</h3>
            ...
            <div className="text-center p-8 group">
              ...
              <h3 className="text-xl font-light mb-3 text-gray-900">Гарантия 12 месяцев</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="text-center p-8 group">
              ...
              <h3 className="text-xl font-light mb-3 text-gray-900">Ремонт любых жалюзи</h3>
              <p className="text-gray-600 leading-relaxed">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {promotions.map((promotion) => (
                <div key={promotion.id} className="bg-slate-50 rounded-2xl p-8">
                  {promotion.badge && (
                    <span className="inline-flex items-center rounded-full bg-red-50 px-3 py-1 text-sm font-medium text-red-700 mb-6">
                      {promotion.badge}
                    </span>
                  )}
                  <h3 className="text-xl font-light mb-4 text-gray-900">{promotion.title}</h3>
