...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses = 'inline-flex items-center justify-center px-4 py-2 border border rounded-md text-sm font-medium transition-colors duration-200 ease-in-out'
